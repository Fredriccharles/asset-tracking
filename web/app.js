...
function createApp() {
  ...
  // same Express process, so the whole app runs on a single port with no
  // external network dependency. In the self-contained web/ folder the
  // built client lives at web/client/dist (copied here during packaging).
